...
export const journalPresets: Record<string, { label: string; icon: string; description: string }> = {
  ...
  nature: { label: "Nature", icon: "N", description: "Nature 风格" },
  science: { label: "Science", icon: "S", description: "Science 风格" },
  cell: { label: "Cell", icon: "C", description: "Cell 风格" },
...
export const chartConfigSchema = z.object({
  ...
  fontFamily: z.string().default("\"PingFang SC\", \"Microsoft YaHei\", \"Noto Sans SC\", Inter, Helvetica Neue, Arial, sans-serif"),
...
export const defaultChartConfig: ChartConfig = {
  ...
  lineWidth: 2,
  fontSize: 14,
  fontFamily: "\"PingFang SC\", \"Microsoft YaHei\", \"Noto Sans SC\", Inter, Helvetica Neue, Arial, sans-serif",
  width: 800,
  height: 600,
